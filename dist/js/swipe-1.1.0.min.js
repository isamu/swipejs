...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var o=0;o<e.length;o++){var i=e[o];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,o,i){return o&&t(e.prototype,o),i&&t(e,i),e}}(),SwipeUtil=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"getParameterByName",value:function(t,e){e||(e=window.location.href),t=t.replace(/[\[\]]/g,"\\$&");var o=new RegExp("[?&]"+t+"(=([^&#]*)|&|#|$)"),i=o.exec(e);return i?i[2]?decodeURIComponent(i[2].replace(/\+/g," ")):"":null}},{key:"initSwipe",value:function(e,o,i){$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"});var a=0;location.hash&&(a=Number(location.hash.substr(1)));var n=new SwipeBook(e,a,o,i);if(this.swipe_book=n,$(o).on("click",function(){n.next()}),$(window).on("hashchange",function(){"#"+n.getStep()!=location.hash&&n.show(Number(location.hash.substr(1)))}),$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){n.resize()},250)}),"1"===t.getParameterByName("autoplay")){var s=t.getParameterByName("autoplayDuration")||1e3;console.log("duatio "+s);!function e(){setTimeout(function(){n.next();var o=Number(location.hash.substr(1));console.log(n.getPageSize()),n.getPageSize()>o+1?e():"1"===t.getParameterByName("autoloop")&&setTimeout(function(){n.show(0),e()},s)},s)}()}}},{key:"getSwipeBook",value:function(){return this.swipe_book}},{key:"merge",value:function(t,e){for(var o={},i=Object.keys(t),a=0;a<i.length;a++)o[i[a]]=t[i[a]];for(i=Object.keys(e),a=0;a<i.length;a++)o[i[a]]=e[i[a]];return o}},{key:"initTouchSwipe",value:function(e){$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("#swipe_back").css({"touch-action":"none"});var o=new SwipeBook(e,0,"#swipe","#swipe_back");this.swipe_book=o,this.ratio=null,$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){o.resize()},250)}),$.extend($.easing,{swipe:function(e,o,i,a,n){return Math.abs(t.getRatio())},swipeangle:function(e,o,i,a,n){return i+Math.abs(t.getRatio())*a}}),SwipeTouch.init({start_callback:t.start_event,scroll_callback:t.scroll_event_handler,stop_callback:t.stop_event})}},{key:"getRatio",value:function(){return this.ratio}},{key:"setRatio",value:function(t){this.ratio=t}},{key:"getStatus",value:function(){return this.status}},{key:"setStatus",value:function(t){this.status=t}},{key:"start_event",value:function(e,o){t.getSwipeBook();"stopping"==t.getStatus()&&t.stop(),this.ratio=0,console.log("start ratio "+String(o)),t.setStatus("start")}},{key:"scroll_event_handler",value:function(e,o){var i="start";t.setRatio(o),o>0&&(i="forward"),o<0&&(i="back");var a=t.getSwipeBook();i!=t.getStatus()&&("forward"==i&&("back"==t.getStatus()&&a.prevHide(),a.nextStart(o)),"back"==i&&("forward"==t.getStatus()&&a.nextHide(),a.prevStart(o)),t.setStatus(i)),a.view(o)}},{key:"stop_event",value:function(e,o){t.setRatio(o),o>0?(t.setStatus("stopping"),t.go_ratio(.03)):(t.setStatus("stopping"),t.go_ratio(-.03))}},{key:"stop",value:function(){var e=t.getSwipeBook();t.setStatus("stop"),this.ratio>0?(t.setRatio(1),e.nextEnd()):this.ratio<0&&(t.setRatio(-1),e.prevEnd())}},{key:"go_ratio",value:function(e){if("stopping"==t.getStatus()){this.ratio=this.ratio+e;var o=t.getSwipeBook();if(Math.abs(this.ratio)>1)t.stop();else{var o=t.getSwipeBook();t.setRatio(this.ratio),o.view(this.ratio),setTimeout(function(){t.go_ratio(e)},2)}}}}]),t}();