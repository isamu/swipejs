"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var a=e[i];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,i,a){return i&&t(e.prototype,i),a&&t(e,a),e}}(),SwipeBook=function(){function t(e){var i=arguments.length<=1||void 0===arguments[1]?0:arguments[1],a=this,s=arguments[2],n=arguments[3];_classCallCheck(this,t),$("head").prepend('<meta name="viewport" content="width = 640,user-scalable=no">'),this.data=e,console.log(e.type),"net.swipe.list"==e.type?!function(){var t=[];a.data.items.forEach(function(e,i){t.push('<li><a href="?file='+e.url+'">'+e.title+"</li>")}),$(s).html("<ul>"+t.join("")+"</ul>")}():(this.step=i,this.pages=[],this.title="Swipe",this.base_css_id=s,this.back_css_id=n,t.setTemplateElements(this.getTemplateElements()),t.setMarkdown(this.getMarkdown()),this.templatePages=this.getTemplatePages(),this.setScreen(),this.paging=this.getPaging(),this.load(),this.domLoad())}return _createClass(t,null,[{key:"setTemplateElements",value:function(t){this.templateElements=t}},{key:"getTemplateElements",value:function(){return this.templateElements}},{key:"setMarkdown",value:function(t){this.markdown=t}},{key:"getMarkdown",value:function(){return this.markdown}},{key:"pageInDuration",value:function(){return 400}}]),_createClass(t,[{key:"setScreen",value:function(){this.dimension=this.data.dimension?this.data.dimension:[$(window).width(),$(window).height()],SwipeScreen.init(this.dimension[0],this.dimension[1]),this.bc=this.data.bc||"#a9a9a9",this.setSwipeCss()}},{key:"load",value:function(){var t=this;$.each(this.data.pages,function(e,i){var a;i.scene&&(a=t.templatePages[i.scene])&&(a=t.templatePages[i.scene]),i.template&&(a=t.templatePages[i.template])&&(a=t.templatePages[i.template]);var s=new SwipePage(i,a,e);t.pages.push(s)}),this.data.title&&(this.title=this.data.title,document.title=this.title)}},{key:"getTemplatePages",value:function(){return this.data.templates&&this.data.templates.pages?this.data.templates.pages:this.data.scenes?this.data.scenes:{}}},{key:"getTemplateElements",value:function(){return this.data.templates&&this.data.templates.elements?this.data.templates.elements:this.data.elements?this.data.elements:{}}},{key:"getMarkdown",value:function(){return this.data.markdown?this.data.markdown:{}}},{key:"getPaging",value:function(){return"leftToRight"==this.data.paging||"vertical"==this.data.paging||"rightToLeft"==this.data.paging?this.data.paging:"vertical"}},{key:"setSwipeCss",value:function(){var t=($(window).width()-SwipeScreen.virtualwidth())/2;$(this.base_css_id).css({height:SwipeScreen.virtualheight(),width:SwipeScreen.virtualwidth(),position:"absolute",left:t}),$(this.back_css_id).css({"background-color":this.bc,height:"100vh",width:"100vw"})}},{key:"resize",value:function(){this.setScreen();for(var t=0;t<this.pages.length;t++)this.justShow(t);this.setPageSize()}},{key:"setPageSize",value:function(){$("svg").css("overflow","visible"),$(".page").css({overflow:"hidden",height:SwipeScreen.virtualheight(),width:SwipeScreen.virtualwidth()})}},{key:"domLoad",value:function(){var t=[],e=this;this.pages.forEach(function(e,i){e.loadElement(),t.push(e.getHtml())}),$(this.base_css_id).html(t.join("")),this.setPageSize(),$(".page").css("opacity",0),$("#page_"+this.step).css("opacity",1),this.pages[this.step].active(),$(".image_element").load(function(){$(this).attr("__default_width",$(this).width()),$(this).attr("__default_height",$(this).height()),$("#"+$(this).attr("__base_id")).attr("__default_width",$(this).width()),$("#"+$(this).attr("__base_id")).attr("__default_height",$(this).height()),e.initData($(this).attr("__page_id"),$(this).attr("__element_id")),SwipeCounter.decrease(),0==SwipeCounter.getCounter()&&e.loadFinish()}),$(".element").each(function(t,i){e.initData($(i).attr("__page_id"),$(i).attr("__element_id")),SwipeCounter.decrease(),0==SwipeCounter.getCounter()&&e.loadFinish()}),this.pages.forEach(function(t,e){var i=t.getBc();$("#page_"+e).css({"background-color":i})}),$(".page").css({position:"absolute"}),$(".image_element").css({position:"absolute"}),$(".image_box").css({position:"absolute"}),$(".image_box").css({overflow:"hidden"}),$(".video_element").css({position:"absolute"}),$(".text_element").css({position:"absolute"}),$(".svg_element").css({position:"absolute"})}},{key:"loadFinish",value:function(){this.show(this.step)}},{key:"initData",value:function(t,e){this.pages[t].initElement(e)}},{key:"next",value:function(){this.step<this.pages.length-1&&this.show(this.step+1)}},{key:"back",value:function(){this.step>0&&this.show(this.step-1)}},{key:"justShow",value:function(t){this.pages[t].justShow()}},{key:"show",value:function(e){var i=this.step,a=e>=i?"forward":"back",s=e==i,n=this.pages[i].getScene()&&this.pages[e]&&this.pages[e].getScene()==this.pages[i].getScene();s||(this.pages[i].inactive(),this.pages[e].active());var o=this.pages[Math.max(i,e)].getTransition();"forward"==a?n?(this.pages[e].show(),this.pages[e].play(),$("#page_"+i).css("opacity",0),$("#page_"+e).css("opacity",1)):"fadeIn"==o?(this.pages[e].finShow(),$("#page_"+e).animate({opacity:1},{duration:t.pageInDuration()})):"replace"==o?($("#page_"+i).css({opacity:0}),$("#page_"+e).css({opacity:1}),this.pages[e].finShow()):"scroll"==o&&(setTimeout(function(){$("#page_"+i).css({opacity:0})},t.pageInDuration()),this.pageSlide("in",e),this.pages[e].delayShow()):(console.log("back"),n?(this.pages[i].back(),setTimeout(function(){$("#page_"+i).css({opacity:0}),$("#page_"+e).css({opacity:1})},t.pageInDuration())):"fadeIn"==o?(this.pages[e].finShow(),$("#page_"+i).animate({opacity:0},{duration:t.pageInDuration()})):"replace"==o?($("#page_"+i).css({opacity:0}),$("#page_"+e).css({opacity:1}),this.pages[e].finShow()):"scroll"==o&&($("#page_"+e).css({opacity:1}),this.pages[i].back(),this.pageSlide("out",i),this.pages[e].finShow())),this.step=e,location.hash=e}},{key:"getStep",value:function(){return this.step}},{key:"pageSlide",value:function(e,i){if($(".boxelement-"+i).each(function(i,a){if(console.log("box"),"in"==e)if("vertical"==this.paging)var s=$("#"+this.css_id).attr("__x"),n=s+SwipeScreen.virtualheight();else if("leftToRight"==this.paging)var o=$("#"+this.css_id).attr("__y"),h=o+SwipeScreen.virtualwidth();else var o=$("#"+this.css_id).attr("__y"),h=o-SwipeScreen.virtualwidth();else if("vertical"==this.paging)var n=$("#"+this.css_id).attr("__x"),s=n+SwipeScreen.virtualheight();else if("leftToRight"==this.paging)var h=$("#"+this.css_id).attr("__y"),o=h+SwipeScreen.virtualwidth();else var h=$("#"+this.css_id).attr("__y"),o=h-SwipeScreen.virtualwidth();"vertical"==this.paging?($(a).css("top",n),$(a).animate({top:s},{duration:t.pageInDuration()})):($(a).css("left",h),$(a).animate({left:o},{duration:t.pageInDuration()}))}),"in"==e)"vertical"==this.paging?($("#page_"+i).css("top",SwipeScreen.virtualheight()),$("#page_"+i).css("opacity",1),$("#page_"+i).animate({top:0,opacity:1},{duration:t.pageInDuration()})):"leftToRight"==this.paging?($("#page_"+i).css("left",SwipeScreen.virtualwidth()),$("#page_"+i).css("opacity",1),$("#page_"+i).animate({left:0,opacity:1},{duration:t.pageInDuration()})):($("#page_"+i).css("left",-SwipeScreen.virtualwidth()),$("#page_"+i).css("opacity",1),$("#page_"+i).animate({left:0,opacity:1},{duration:t.pageInDuration()}));else{var a={duration:t.pageInDuration(),complete:function(){$("#page_"+i).css({opacity:0})}};"vertical"==this.paging?($("#page_"+i).css("top",0),$("#page_"+i).animate({top:SwipeScreen.virtualheight()},a)):"leftToRight"==this.paging?($("#page_"+i).css("left",0),$("#page_"+i).css("opacity",1),$("#page_"+i).animate({left:SwipeScreen.virtualwidth(),opacity:1},a)):($("#page_"+i).css("left",0),$("#page_"+i).css("opacity",1),$("#page_"+i).animate({left:-SwipeScreen.virtualwidth(),opacity:1},a))}}}]),t}();
...
"use strict";function _classCallCheck(i,t){if(!(i instanceof t))throw new TypeError("Cannot call a class as a function")}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol?"symbol":typeof i},_createClass=function(){function i(i,t){for(var e=0;e<t.length;e++){var s=t[e];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(i,s.key,s)}}return function(t,e,s){return e&&i(t.prototype,e),s&&i(t,s),t}}(),SwipeElement=function(){function i(t,e,s,n,o){var a=arguments.length<=5||void 0===arguments[5]?null:arguments[5];_classCallCheck(this,i);var r="element-"+e+"-"+s;this.info=this.mergeTemplate(t),this.css_id=r,this.page_id=e,this.element_id=s,this.play_style=n,this.duration=o,this.parent=a,this.isActive=!1,this.videoElement=null,this.isRepeat=Boolean(t.repeat),this.x=0,this.y=0,this.angle=0,this.scale=[1,1],this.no_size=!1,this.transition_timing=null,this.loop_timing=null,this.elements=[];var h=this;this.bc=null,this.info.bc&&(this.bc=this.info.bc),this.info.elements&&this.info.elements.forEach(function(t,a){var r=s+"-"+a;h.elements.push(new i(t,e,r,n,o,h))})}return _createClass(i,[{key:"mergeTemplate",value:function(i){if(i.element||i.template){var t,e=SwipeBook.getTemplateElements();(t=e[i.element||i.template])&&(i=SwipeParser.inheritProperties(i,t))}return i}},{key:"parseText",value:function(i){return"string"==typeof i?i:"object"==("undefined"==typeof i?"undefined":_typeof(i))?i.ref?SwipeParser.localizedStringForKey(i.ref):SwipeParser.localizedString(i,"ja"):""}},{key:"parseMarkdown",value:function(i){var t=SwipeBook.getMarkdown(),e=new SwipeMarkdown(t);return e.parse(i,this.css_id)}},{key:"initData",value:function(i){if(void 0!==i){var t=i.split("-");return void(1==t.length?this.elements[i].initData():this.elements[t.shift()].initData(t.join("-")))}if((this.isDiv()||this.isMarkdown())&&(this.parent||$("#"+this.css_id).css("position","absolute")),this.isPath()&&(this.snap=Snap("#"+this.css_id),this.path=this.snap.path()),this.setSize(),this.setPosition(),this.setOption(),$("#"+this.css_id).attr("__x",this.x),$("#"+this.css_id).attr("__y",this.y),$("#"+this.css_id).attr("__w",this.w),$("#"+this.css_id).attr("__h",this.h),this.bc&&$("#"+this.css_id).css({"background-color":this.bc}),this.isImage()){var e=this.w/this.h,s=$("#"+this.css_id+"_image").attr("__default_width"),n=$("#"+this.css_id+"_image").attr("__default_height"),o=s/n;e<o?($("#"+this.css_id+"_image").css("height","100%"),$("#"+this.css_id+"_image").css("width","auto")):($("#"+this.css_id+"_image").css("height","auth"),$("#"+this.css_id+"_image").css("width","100%")),$("#"+this.css_id+"_image").css("top","50%"),$("#"+this.css_id+"_image").css("left","50%"),$("#"+this.css_id+"_image").css("-webkit-transform","translateY(-50%) translateX(-50%)")}this.initAllData(),this.isPath()&&(this.prevPath=this.parsePath(),this.finPath=this.parseFinPath()),this.setPrevPos(),this.markdown_position()}},{key:"initAllData",value:function(){this.initPosData=[Number(this.x),Number(this.y),Number(this.w),Number(this.h),Number(this.angle),Number(this.opacity),this.scale],this.originalPrevPos=this.updatePosition(this.initPosData,this.info),this.prevPos=this.getScreenPosition(this.originalPrevPos),this.originalFinPos=this.getOriginalFinPos(),this.finPos=this.getScreenPosition(this.originalFinPos),this.isText()&&(this.prevText=this.textLayout(this.info,this.prevPos),this.finText=this.textLayout(this.info,this.finPos))}},{key:"getOriginalFinPos",value:function(){if(this.hasTo()){var i=this.initPosData;return this.info.to.pos&&this.info.to.pos.match(/^M/),this.updatePosition(i,SwipeUtil.merge(this.info,this.info.to))}return this.originalPrevPos}},{key:"path2pos",value:function(i){var t=[0,0],e=i.match(/(\w[0-9\s\.,\-]+)/g);return $.each(e,function(i,e){var s=e.slice(0,1),n=e.slice(1).split(",");"M"==s&&(t=[Number(n[0]),Number(n[1])]),"l"==s&&(t=[Number(t[0])+Number(n[0]),Number(t[1])+Number(n[1])])}),t}},{key:"setOption",value:function(){this.opacity=1,null!=this.info.opacity&&(this.opacity=this.info.opacity),this.info.clip&&this.info.clip===!0&&$("#"+this.css_id).css("overflow","hidden")}},{key:"setSize",value:function(){this.info.size?(this.w=this.info.size[0],this.h=this.info.size[1]):(this.info.w?this.w=SwipeParser.parseSize(this.info.w,SwipeScreen.swipewidth(),SwipeScreen.swipewidth()):this.isImage()?this.w=$("#"+this.css_id).attr("__default_width"):(this.w=this.parentWidth(),this.no_size=!0),this.info.h?this.h=SwipeParser.parseSize(this.info.h,SwipeScreen.swipeheight(),SwipeScreen.swipeheight()):this.isImage()?this.h=$("#"+this.css_id).attr("__default_height"):(this.h=this.parentHeight(),this.no_size=!0))}},{key:"setPosition",value:function(){this.info.pos?(this.x=this.info.pos[0],this.y=this.info.pos[1]):("right"==this.info.x?this.x=this.parentWidth()-this.w:"left"==this.info.x?this.x=0:"center"==this.info.x?this.x=(this.parentWidth()-this.w)/2:this.info.x&&(this.x=SwipeParser.parseSize(this.info.x,this.parentWidth(),0)),"bottom"==this.info.y?this.y=this.parentHeight()-this.h:"top"==this.info.y?this.y=0:"center"==this.info.y?this.y=(this.parentHeight()-this.h)/2:this.info.y&&(this.y=SwipeParser.parseSize(this.info.y,this.parentHeight(),0))),this.info.rotate&&(this.angle=this.info.rotate),this.scale=this.getScale(this.info)}},{key:"getWidth",value:function(){return this.w?this.w:this.parent?this.parent.getWidth():SwipeScreen.swipewidth()}},{key:"getHeight",value:function(){return this.h?this.h:this.parent?this.parent.getHeight():SwipeScreen.swipeheight()}},{key:"parentWidth",value:function(){var i;return this.parent&&(i=this.parent.getWidth()),i?i:SwipeScreen.swipewidth()}},{key:"parentHeight",value:function(){var i;return this.parent&&(i=this.parent.getHeight()),i?i:SwipeScreen.swipeheight()}},{key:"setVideo",value:function(i){var t=this;$("#"+this.css_id).html("<video id='"+this.css_id+"-video' width='"+i[2]+"' height='"+i[3]+"'><source type='video/mp4' src='"+this.info.video+"'  /></video>"),$("#"+this.css_id+"-video").mediaelementplayer({flashName:"flashmediaelement.swf",loop:!0,success:function(i,e){t.videoElement=i}})}},{key:"setPrevPos",value:function(){var i=this;$("#"+this.css_id).css(this.convCssPos(this.prevPos)),this.isVideo()&&this.setVideo(this.prevPos),this.isText()&&$("#"+this.css_id+"-body").css(this.prevText),this.isPath()&&this.path.attr({d:this.prevPath.d,fill:this.prevPath.fill,transform:this.prevPath.transform,stroke:this.prevPath.stroke,strokeWidth:this.prevPath.strokeWidth}),this.isMarkdown()&&this.md_css.forEach(function(t,e){$("#"+i.css_id+"-"+e).css(t)})}},{key:"textLayout",value:function(i,t){var e="center",s="center";if(i.textAlign)switch(i.textAlign){case"left":s="left";break;case"right":s="right";break;case"top":e="top";break;case"bottom":e="bottom"}var n=SwipeParser.parseFontName(i,!1),o=function(i,t){var e=20/480*SwipeScreen.swipeheight(),s=SwipeParser.parseFontSize(i,SwipeScreen.swipeheight(),e,!1);return Math.round(s*t[1])}(i,t[6]),a=o,r=t[3],h=0;return"bottom"==e?h=r-a:"center"==e&&(h=(r-a)/2),{position:"relative",top:String(SwipeScreen.virtualY(h))+"px","font-size":String(SwipeScreen.virtualY(o))+"px","line-height":String(SwipeScreen.virtualY(o))+"px","font-family":n,textAlign:s,color:SwipeParser.parseColor(i,"#000")}}},{key:"conv_rgba2rgb",value:function(i){var t=void 0;return(t=i.match(/^(#\w{6})(\w{2})$/))?t[1]:i}},{key:"transform",value:function(i,t){var e=[],s=[SwipeScreen.getRation(),SwipeScreen.getRation()];t&&(s=[s[0]*t[0],s[1]*t[1]]);var n=[s[0],s[1],this.initPosData[2]/2,this.initPosData[3]/2];e.push("scale("+n.join(",")+")");var o=i.rotate?[i.rotate[2],this.initPosData[2]/2,this.initPosData[3]/2].join(","):"0,0,0";return e.push("rotate("+o+")"),e.join(" ")}},{key:"parsePath",value:function(){var i=this.info.lineWidth?this.info.lineWidth:1,t=this.info.strokeColor?this.info.strokeColor:"black",e=this.info.fillColor?this.info.fillColor:"none";return{d:this.info.path,stroke:this.conv_rgba2rgb(t),transform:this.transform(this.info,this.scale),fill:this.conv_rgba2rgb(e),strokeWidth:i}}},{key:"parseFinPath",value:function(){if(!this.hasTo())return this.prevPath;var i=SwipeUtil.merge(this.info,this.info.to),t=i.lineWidth?i.lineWidth:1,e=i.strokeColor?i.strokeColor:"black",s=i.fillColor?i.fillColor:"none";i.rotate?[i.rotate[2],this.prevPos[2]/2,this.prevPos[3]/2].join(","):"0,0,0";return{d:i.path,stroke:this.conv_rgba2rgb(e),transform:this.transform(i,this.getScale(i)),fill:this.conv_rgba2rgb(s),strokeWidth:t}}},{key:"animatePrevPos",value:function(){if($("#"+this.css_id).animate(this.convCssPos(this.prevPos),{duration:this.duration}),this.hasTo()&&(this.isText()&&$("#"+this.css_id+"-body").animate(this.prevText,{duration:this.duration}),this.isPath())){var i=SwipeParser.clone(this.prevPath);delete i.stroke,this.path.animate(i,this.duration)}}},{key:"markdown_position",value:function(){if(this.isMarkdown()){var i=($("#"+this.css_id).height()-$("#md_"+this.css_id).height())/2;$("#md_"+this.css_id).css({top:i,position:"absolute"})}}},{key:"setFinPos",value:function(){if($("#"+this.css_id).css(this.convCssPos(this.finPos)),this.isVideo()&&this.setVideo(this.finPos),this.isText()){var i=this.textLayout(this.info,this.finPos);$("#"+this.css_id+"-body").css(i)}}},{key:"animateFinPos",value:function(){if(this.hasTo()){this.transition_timing=this.getTiming(this.info.to,this.duration);var i=this.transition_timing[0],t=this.transition_timing[1],e=this;setTimeout(function(){if($("#"+e.css_id).animate(e.convCssPos(e.finPos),{duration:t}),e.isText()&&$("#"+e.css_id+"-body").animate(e.finText,{duration:t}),e.isPath()){var i=SwipeParser.clone(e.finPath);delete i.stroke,e.path.animate(i,t)}},i)}}},{key:"updatePosition",value:function(i,t){var e=Object.assign({},i);if(null!=t.opacity&&(e[5]=Number(t.opacity)),t.translate){var s=t.translate;e[0]=e[0]+Number(s[0]),e[1]=e[1]+Number(s[1])}return this.isPath()||t.scale&&(e[6]=this.getScale(t),e=this.applyScale(e)),e}},{key:"getScreenPosition",value:function(i){return[SwipeScreen.virtualX(i[0]),SwipeScreen.virtualY(i[1]),SwipeScreen.virtualX(i[2]),SwipeScreen.virtualY(i[3]),i[4],i[5],i[6]]}},{key:"getScale",value:function(i){var t=arguments.length<=1||void 0===arguments[1]?[1,1]:arguments[1];return i.scale&&(SwipeParser.is("Array",i.scale)&&2==i.scale.length?t=i.scale:SwipeParser.is("Number",i.scale)?t=[i.scale,i.scale]:SwipeParser.is("String",i.scale)&&(t=[Number(i.scale),Number(i.scale)])),t}},{key:"applyScale",value:function(i){var t=i[6];if(t&&2==t.length&&1!=t[0]&&1!=t[1]){var e=i[2]*t[0],s=i[3]*t[1],n=i[0]-(e-i[2])/2,o=i[1]-(s-i[3])/2;i[0]=n,i[1]=o,i[2]=e,i[3]=s}return i}},{key:"convCssPos",value:function(i){var t={left:i[0]+"px",top:i[1]+"px",width:i[2]+"px",height:i[3]+"px",opacity:i[5]};if(i[4]){var e="rotate("+i[4]+"deg)";t["-moz-transform"]=e,t["-webkit-transform"]=e,t["-o-transform"]=e,t["-ms-transform"]=e}return t}},{key:"type",value:function(){return this.info.img?"image":this.info.video?"video":this.info.text?"text":this.info.markdown?"markdown":this.info.path?"path":"div"}},{key:"isImage",value:function(){return"image"==this.type()}},{key:"isVideo",value:function(){return"video"==this.type()}},{key:"isText",value:function(){return"text"==this.type()}},{key:"isMarkdown",value:function(){return"markdown"==this.type()}},{key:"isPath",value:function(){return"path"==this.type()}},{key:"isDiv",value:function(){return"div"==this.type()}},{key:"hasTo",value:function(){return!!this.info.to}},{key:"html",value:function(){this.type()&&SwipeCounter.increase();var i=this.elements.map(function(i,t){return i.html()}).join("");if(this.isImage())return"<div id='"+this.css_id+"' class='image_box'><div id='"+this.css_id+"_inner'><img src='"+this.info.img+"' class='image_element' id='"+this.css_id+"_image' __page_id='"+this.page_id+"' __element_id='"+this.element_id+"' __base_id='"+this.css_id+"' >"+i+"</img></div></div>";if(this.isText())return"<div class='element text_element' id='"+this.css_id+"' __page_id='"+this.page_id+"' __element_id='"+this.element_id+"' ><div class='text_body' id='"+this.css_id+"-body'>"+this.parseText(this.info.text)+i+"</div></div>";if(this.isMarkdown()){var t=this.parseMarkdown(this.info.markdown);return this.md_css=t[1],"<div class='element markdown_element' id='"+this.css_id+"' __page_id='"+this.page_id+"' __element_id='"+this.element_id+"' ><div class='markdown_wrap' id='md_"+this.css_id+"'>"+t[0]+i+"</div></div>"}return this.isVideo()?"<div class='element video_element' id='"+this.css_id+"' __page_id='"+this.page_id+"' __element_id='"+this.element_id+"' >"+i+"</div>":this.isPath()?'<svg class="element svg_element" id="'+this.css_id+'" __page_id="'+this.page_id+'" __element_id="'+this.element_id+'" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"></svg>':this.isDiv()?"<div class='element boxelement-"+this.page_id+"' id='"+this.css_id+"' __page_id='"+this.page_id+"' __element_id='"+this.element_id+"' >"+i+"</div>":""}},{key:"justShow",value:function(){console.log("justShow"),this.elements&&this.elements.forEach(function(i,t){i.justShow()}),this.no_size&&this.setSize(),this.setFinPos()}},{key:"show",value:function(){console.log("show"),this.elements&&this.elements.forEach(function(i,t){i.show()}),this.setPrevPos(),this.animateFinPos(),this.loopProcess()}},{key:"delayShow",value:function(){console.log("delayShow"),this.elements&&this.elements.forEach(function(i,t){i.delayShow()}),this.setPrevPos();var i=this;setTimeout(function(){i.animateFinPos(),i.loopProcess()},SwipeBook.pageInDuration())}},{key:"getTiming",value:function(i,t){var e=function(i){if(i.timing){var t=i.timing;if(2==t.length&&t[0]>0&&t[1]>=t[0]&&t[1]<=1)return t}return[0,1]}(i);return[e[0],e[1]-e[0],1-e[1]].map(function(i){return i*t})}},{key:"getLoopDuration",value:function(i){var t=i;return this.transition_timing&&(t=0==this.transition_timing[2]?200:this.transition_timing[2]),this.valueFrom(this.info.loop,"duration",t)}},{key:"loopProcess",value:function(){if(this.info.loop){var i=this.getLoopDuration(this.duration);if(this.loop_timing=this.getTiming(this.info.loop,i),"scroll"!=this.play_style&&this.hasTo())if("auto"==this.play_style||"always"==this.play_style){var t=this.duration;this.transition_timing&&(t-=this.transition_timing[2]);var e=this;setTimeout(function(){e.loop(e)},t)}else console.log("not animate because "+this.play);else this.loop(this)}}},{key:"moreloop",value:function(i,t,e){t--;var s=this.loop_timing[2];setTimeout(function(){t>0?i.loop(i,t):i.isRepeat&&i.isActive&&(t=e,i.loop(i,t))},s)}},{key:"loop",value:function(i){var t=arguments.length<=1||void 0===arguments[1]?null:arguments[1];console.log("loop");var e,s=i.info.loop,n=this.loop_timing[0],o=this.loop_timing[1];e=s.count?s.count:1,null==t&&(t=e),setTimeout(function(){switch(s.style){case"vibrate":var n=i.valueFrom(s,"delta",10),a=i.originalFinPos,r=o/e/4;$("#"+i.css_id).animate({left:parseInt(SwipeScreen.virtualX(a[0]-n))+"px",top:SwipeScreen.virtualY(a[1])+"px"},{duration:r}),setTimeout(function(){$("#"+i.css_id).animate({left:parseInt(SwipeScreen.virtualX(a[0]+n))+"px",top:SwipeScreen.virtualY(a[1])+"px"},{duration:2*r}),setTimeout(function(){$("#"+i.css_id).animate({left:parseInt(SwipeScreen.virtualX(a[0]))+"px",top:SwipeScreen.virtualY(a[1])+"px"},{duration:r}),setTimeout(function(){t--,t>0?i.loop(i,t):i.isRepeat&&i.isActive&&(t=e,i.loop(i,t))},r)},2*r)},r);break;case"shift":var h,a=i.originalFinPos;switch(s.direction){case"n":h={left:parseInt(SwipeScreen.virtualX(s[0]))+"px",top:SwipeScreen.virtualY(s[1]-i.h)+"px"};break;case"e":h={left:parseInt(SwipeScreen.virtualX(s[0]+i.w))+"px",top:SwipeScreen.virtualY(s[1])+"px"};break;case"w":h={left:parseInt(SwipeScreen.virtualX(s[0]-i.w))+"px",top:SwipeScreen.virtualY(s[1])+"px"};break;default:h={left:parseInt(SwipeScreen.virtualX(s[0]))+"px",top:SwipeScreen.virtualY(s[1]-i.h)+"px"}}var r=o/e;i.setPrevPos(),$("#"+i.css_id).animate(h,{duration:r,complete:function(){$("#"+i.css_id).animate(i.convCssPos(a,1),{duration:0,complete:function(){i.moreloop(i,t,e)}})}});break;case"blink":console.log("blink");var r=o/e/4;$("#"+i.css_id).css({opacity:1}),setTimeout(function(){$("#"+i.css_id).css({opacity:0}),setTimeout(function(){$("#"+i.css_id).css({opacity:1}),setTimeout(function(){i.moreloop(i,t,e)},r)},2*r)},r);break;case"spin":console.log("spin");var r=o/e;$("#"+i.css_id).rotate({angle:0,animateTo:360,duration:r,callback:function(){i.moreloop(i,t,e)}});break;case"wiggle":console.log("wiggle");var l=i.valueFrom(s,"delta",15),r=o/e/4;$("#"+i.css_id).rotate({angle:0,animateTo:l,duration:r,callback:function(){$("#"+i.css_id).rotate({angle:l,animateTo:-l,duration:2*r,callback:function(){$("#"+i.css_id).rotate({angle:-l,animateTo:0,duration:r,callback:function(){i.moreloop(i,t,e)}})}})}});break;case"path":case"sprite":}},n)}},{key:"valueFrom",value:function(i,t,e){return i[t]?i[t]:e}},{key:"back",value:function(){console.log("back"),this.elements&&this.elements.forEach(function(i,t){i.back()}),this.setFinPos(),this.animatePrevPos()}},{key:"finShow",value:function(){console.log("finShow"),this.elements&&this.elements.forEach(function(i,t){i.finShow()}),this.setFinPos(),this.loopProcess()}},{key:"play",value:function(){this.elements&&this.elements.forEach(function(i,t){i.play()}),this.videoElement&&this.videoElement.play()}},{key:"inactive",value:function(){this.elements&&this.elements.forEach(function(i,t){i.inactive()}),this.isActive=!1}},{key:"active",value:function(){this.elements&&this.elements.forEach(function(i,t){i.active()}),this.isActive=!0}}]),i}();
