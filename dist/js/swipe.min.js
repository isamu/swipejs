...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,n,o){return n&&t(e.prototype,n),o&&t(e,o),e}}(),SwipeUtil=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"getParameterByName",value:function(t,e){e||(e=window.location.href),t=t.replace(/[\[\]]/g,"\\$&");var n=new RegExp("[?&]"+t+"(=([^&#]*)|&|#|$)"),o=n.exec(e);return o?o[2]?decodeURIComponent(o[2].replace(/\+/g," ")):"":null}},{key:"initSwipe",value:function(t,e,n){$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"});var o=0;location.hash&&(o=Number(location.hash.substr(1)));var i=new SwipeBook(t,o,e,n);this.swipe_book=i,$(e).on("click",function(){i.next()}),$(window).on("hashchange",function(){"#"+i.getStep()!=location.hash&&i.show(Number(location.hash.substr(1)))}),$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){i.resize()},250)})}},{key:"getSwipeBook",value:function(){return this.swipe_book}},{key:"merge",value:function(t,e){for(var n={},o=Object.keys(t),i=0;i<o.length;i++)n[o[i]]=t[o[i]];for(o=Object.keys(e),i=0;i<o.length;i++)n[o[i]]=e[o[i]];return n}},{key:"initTouchSwipe",value:function(e){$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"});var n=new SwipeBook(e,0,"#swipe","#swipe_back");this.swipe_book=n,this.ration=null,$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){n.resize()},250)}),$.extend($.easing,{swipe:function(e,n,o,i,a){return Math.abs(t.getRation())}}),SwipeTouch.init({start_callback:t.start_event,scroll_callback:t.scroll_event_handler,stop_callback:t.stop_event})}},{key:"getRation",value:function(){return this.ration}},{key:"setRation",value:function(t){this.ration=t}},{key:"getStatus",value:function(){return this.status}},{key:"setStatus",value:function(t){this.status=t}},{key:"start_event",value:function(e,n){t.getSwipeBook();"stopping"==t.getStatus()&&t.stop(),this.ration=0,t.setStatus("start")}},{key:"scroll_event_handler",value:function(e,n){var o="start";t.setRation(n),n>0&&(o="forward"),n<0&&(o="back");var i=t.getSwipeBook();o!=t.getStatus()&&("forward"==o&&i.nextStart(n),"back"==o&&i.prevStart(n),t.setStatus(o)),i.view(n)}},{key:"stop_event",value:function(e,n){t.setRation(n),n>0?(t.setStatus("stopping"),t.go_ration(.1)):(t.setStatus("stopping"),t.go_ration(-.1))}},{key:"stop",value:function(){var e=t.getSwipeBook();t.setStatus("stop"),this.ration>0?(t.setRation(1),e.nextEnd()):this.ration<0&&(t.setRation(-1),e.prevEnd())}},{key:"go_ration",value:function(e){if(console.log(t.getStatus()),"stopping"==t.getStatus()){this.ration=this.ration+e;var n=t.getSwipeBook();if(Math.abs(this.ration)>1)t.stop();else{var n=t.getSwipeBook();n.view(this.ration),setTimeout(function(){t.go_ration(e)},10)}}}}]),t}();