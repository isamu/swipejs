...
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,n){for(var o=0;o<n.length;o++){var i=n[o];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(n,o,i){return o&&e(n.prototype,o),i&&e(n,i),n}}(),SwipeUtil=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"getParameterByName",value:function(e,n){n||(n=window.location.href),e=e.replace(/[\[\]]/g,"\\$&");var o=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)"),i=o.exec(n);return i?i[2]?decodeURIComponent(i[2].replace(/\+/g," ")):"":null}},{key:"initSwipe",value:function(e,n,o){$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"});var i=0;location.hash&&(i=Number(location.hash.substr(1))),this.swipe_book=new SwipeBook(e,i,n,o),$(n).on("click",function(){this.swipe_book.next()}),$(window).on("hashchange",function(){"#"+this.swipe_book.getStep()!=location.hash&&this.swipe_book.show(Number(location.hash.substr(1)))}),$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){this.swipe_book.resize()},250)})}},{key:"getSwipeBook",value:function(){return this.swipe_book}},{key:"merge",value:function(e,n){for(var o={},i=Object.keys(e),t=0;t<i.length;t++)o[i[t]]=e[i[t]];for(i=Object.keys(n),t=0;t<i.length;t++)o[i[t]]=n[i[t]];return o}}]),e}();