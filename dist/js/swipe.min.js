...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_createClass=function(){function t(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,o,n){return o&&t(e.prototype,o),n&&t(e,n),e}}(),SwipeUtil=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"getParameterByName",value:function(t,e){e||(e=window.location.href),t=t.replace(/[\[\]]/g,"\\$&");var o=new RegExp("[?&]"+t+"(=([^&#]*)|&|#|$)"),n=o.exec(e);return n?n[2]?decodeURIComponent(n[2].replace(/\+/g," ")):"":null}},{key:"reloadSwipe",value:function(t,e,o){location.hash;var n=new SwipeBook(t,0,e,o);this.swipe_book=n}},{key:"initSwipe",value:function(e,o,n){arguments.length>3&&void 0!==arguments[3]&&arguments[3];$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"});var i=0;location.hash&&(i=Number(location.hash.substr(1)));var a=new SwipeBook(e,i,o,n);if(this.swipe_book=a,$(o).on("click",function(){a.next()}),$(window).on("hashchange",function(){var t=Number(location.hash.substr(1));"#"+a.getStep()!=location.hash&&(a.getStep()>t?a.back():a.next())}),$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){a.resize()},250)}),"1"===t.getParameterByName("autoplay")){var r=t.getParameterByName("autoplayDuration")||1e3;console.log("duatio "+r);!function e(){setTimeout(function(){a.next();var o=Number(location.hash.substr(1));console.log(a.getPageSize()),a.getPageSize()>o+1?e():"1"===t.getParameterByName("autoloop")&&setTimeout(function(){a.show(0),e()},r)},r)}()}}},{key:"getSwipeBook",value:function(){return this.swipe_book}},{key:"merge",value:function(t,e){for(var o={},n=Object.keys(t),i=0;i<n.length;i++)o[n[i]]=t[n[i]];for(n=Object.keys(e),i=0;i<n.length;i++)o[n[i]]=e[n[i]];return o}},{key:"initTouchSwipe",value:function(e){var o=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"#swipe",n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"#swipe_back";$(document.body).css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$("div").css({margin:0,padding:0,"background-color":"#fff","font-size":"26px"}),$(n).css({"touch-action":"none"});var i=new SwipeBook(e,0,o,n);this.swipe_book=i,this.ratio=null,$(window).resize(function(){clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(){i.resize()},250)}),$.extend($.easing,{swipe:function(e,o,n,i,a){return Math.abs(t.getRatio())},swipeangle:function(e,o,n,i,a){return n+Math.abs(t.getRatio())*i}}),SwipeTouch.init({start_callback:t.start_event,scroll_callback:t.scroll_event_handler,stop_callback:t.stop_event})}},{key:"getRatio",value:function(){return this.ratio}},{key:"setRatio",value:function(t){this.ratio=t}},{key:"getStatus",value:function(){return this.status}},{key:"setStatus",value:function(t){this.status=t}},{key:"start_event",value:function(e,o){t.getSwipeBook();"stopping"==t.getStatus()&&t.stop(),this.ratio=0,console.log("start ratio "+String(o)),t.setStatus("start")}},{key:"scroll_event_handler",value:function(e,o){var n="start";t.setRatio(o),o>0&&(n="forward"),o<0&&(n="back");var i=t.getSwipeBook();n!=t.getStatus()&&("forward"==n&&("back"==t.getStatus()&&i.prevHide(),i.nextStart(o)),"back"==n&&("forward"==t.getStatus()&&i.nextHide(),i.prevStart(o)),t.setStatus(n)),i.view(o)}},{key:"stop_event",value:function(e,o){t.setRatio(o),o>0?(t.setStatus("stopping"),t.go_ratio(.03)):(t.setStatus("stopping"),t.go_ratio(-.03))}},{key:"stop",value:function(){var e=t.getSwipeBook();t.setStatus("stop"),this.ratio>0?(t.setRatio(1),e.nextEnd()):this.ratio<0&&(t.setRatio(-1),e.prevEnd())}},{key:"go_ratio",value:function(e){if("stopping"==t.getStatus()){this.ratio=this.ratio+e;var o=t.getSwipeBook();if(Math.abs(this.ratio)>1)t.stop();else{var o=t.getSwipeBook();t.setRatio(this.ratio),o.view(this.ratio),setTimeout(function(){t.go_ratio(e)},2)}}}},{key:"replaceObject",value:function(e,o,n){return Array.isArray(e)?e=e.map(function(e){return t.replaceObject(e,o,n)}):"object"===(void 0===e?"undefined":_typeof(e))&&null!==e?(Object.keys(e).map(function(i){e[i]=t.replaceObject(e[i],o,n)}),e):e===o?n:e}}]),t}();