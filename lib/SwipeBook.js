...
var _SwipeCounter = require("./SwipeCounter");

var _SwipeCounter2 = _interopRequireDefault(_SwipeCounter);

var _SwipeMediaPlayer = require("./SwipeMediaPlayer");

var _SwipeMediaPlayer2 = _interopRequireDefault(_SwipeMediaPlayer);

var _SwipeScreen = require("./SwipeScreen");
...
var SwipeBook = function () {
	...
	function SwipeBook(data) {
		...
		this.media_player = _SwipeMediaPlayer2.default.getInstance();
	...
	_createClass(SwipeBook, [{
		...
		value: function setScreen() {
			...
			_SwipeScreen2.default.init(this.dimension[0], this.dimension[1]);
		...
		value: function setSwipeCss() {
			var x = ($(window).width() - _SwipeScreen2.default.virtualwidth()) / 2.0;

			$("#loading").css({
				height: _SwipeScreen2.default.virtualheight(),
				width: _SwipeScreen2.default.virtualwidth(),
				"z-index": 100,
			...
			var height = _SwipeScreen2.default.getSize();
		...
		value: function counterDecrease() {
			...
			_SwipeCounter2.default.decrease();
			$("#counter").html(_SwipeCounter2.default.getCounter());
			this.checkAndUpdateNextPage();
		}
	}, {
		key: "checkAndUpdateNextPage",
		value: function checkAndUpdateNextPage() {
			if (_SwipeCounter2.default.getCounter() == 0) {
			...
			console.log(_SwipeCounter2.default.getCounter());
		}
	}, {
		key: "loadFinish",
		...
		value: function pageSlide(mode, step) {
			...
			if (mode == "in") {
				...
				if (this.paging == "vertical") {
					$("#page_" + step).css("top", _SwipeScreen2.default.virtualheight());
					$("#page_" + step).animate({
						"top": 0
					}, {
						duration: SwipeBook.pageInDuration()
					...
					$("#page_" + step).css("left", _SwipeScreen2.default.virtualwidth());
					$("#page_" + step).animate({
						"left": 0
					}, {
						duration: SwipeBook.pageInDuration()
				...
				if (this.paging == "vertical") {
					...
					$("#page_" + step).css("opacity", 1);
					$("#page_" + step).animate({
						"top": -_SwipeScreen2.default.virtualheight()
					}, {
						duration: SwipeBook.pageInDuration()
					});
				} else if (this.paging == "leftToRight") {
					...
					$("#page_" + step).css("opacity", 1);
					$("#page_" + step).animate({
						"left": -_SwipeScreen2.default.virtualwidth()
					}, {
						duration: SwipeBook.pageInDuration()
					});
				} else if (this.paging == "rightToLeft") {
		...
		value: function pageSlideDown(mode, step, loaded) {
			...
			if (mode == "in") {
				...
				if (this.paging == "vertical") {
					$("#page_" + step).css("height", _SwipeScreen2.default.virtualheight());
					setTimeout(function () {
						$("#page_" + step).animate({
							"height": 0
						}, {
					...
					$("#page_" + step).css({ "left": 0, "width": _SwipeScreen2.default.virtualwidth() });
					$("#page_" + step).animate({
						"width": 0
					}, {
						duration: SwipeBook.pageInDuration()
		...
		value: function pageSlideDown2(mode, step, ratio) {
			...
			if (mode == "in") {
				$("#page_" + step).css({ "opacity": 1 });
				if (this.paging == "vertical") {
					$("#page_" + step).css({ "top": 0, "height": _SwipeScreen2.default.virtualheight() * ratio });
					console.log("in vertical slide");
				} else if (this.paging == "leftToRight") {
					$("#page_" + step).css({ "left": 0, "width": _SwipeScreen2.default.virtualwidth() * ratio });
				} else if (this.paging == "rightToLeft") {
					// not supported
				}
			} else if (mode == "back") {
				if (this.paging == "vertical") {
					$("#page_" + step).css({ "top": 0, "height": _SwipeScreen2.default.virtualheight() * (1 + ratio) });
					console.log("in_back vertical slide");
				} else if (this.paging == "leftToRight") {
					$("#page_" + step).css({ "left": 0, "width": _SwipeScreen2.default.virtualwidth() * (1 + ratio) });
				} else if (this.paging == "rightToLeft") {
					// not supported
				}
			}
    ...
    */
		...
		value: function nextEnd() {
			...
			$("#page_" + nextStep).css("opacity", 1);
			$("#page_" + nextStep).css("width", _SwipeScreen2.default.virtualwidth());
			$("#page_" + nextStep).css("height", _SwipeScreen2.default.virtualheight());
		...
		value: function pageSlide2(mode, step, ratio) {
			if (mode == "in") {
				$("#page_" + step).css("opacity", 1);
				if (this.paging == "vertical") {
					$("#page_" + step).css("top", _SwipeScreen2.default.virtualheight() * (1 - ratio));
				} else if (this.paging == "leftToRight") {
					$("#page_" + step).css("left", _SwipeScreen2.default.virtualwidth() * (1 - ratio));
				} else if (this.paging == "rightToLeft") {
					$("#page_" + step).css("left", -_SwipeScreen2.default.virtualwidth());
					$("#page_" + step).animate({
						"left": 0
				...
				if (this.paging == "vertical") {
					$("#page_" + step).css("top", -_SwipeScreen2.default.virtualheight() * ratio);
				} else if (this.paging == "leftToRight") {
					$("#page_" + step).css("left", -_SwipeScreen2.default.virtualheight() * ratio);
					$("#page_" + step).css("opacity", 1);
				} else if (this.paging == "rightToLeft") {
					$("#page_" + step).css("left", _SwipeScreen2.default.virtualheight() * ratio);
					$("#page_" + step).css("opacity", 1);
